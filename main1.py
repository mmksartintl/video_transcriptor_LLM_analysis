...
prompt_extract = PromptTemplate.from_template(
    ...
    {page_data}
    ### INSTRUCTION:
    Scraped text is from a keynote.
    Provide a brief description about this keynote. 
    Highlight important topics covered in this keynote.
...
if uploaded_file is not None:
    ...
    res = chain_extract.invoke(input={'page_data': transcript})
